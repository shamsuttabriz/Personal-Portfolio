                ...
                <div className='md:flex justify-end items-center'>
                    <div className='w-full md:w-6/12 text-slate-500 space-y-5'>
                        <div className=' border-2 shadow-lg text-slate-400font-medium border-slate-500 text-center p-5 space-y-1 rounded-ss-full rounded-se-full'>
                            ...
                            <p className='text-blue-400 pt-2 cursor-pointer'>Send a message</p>
                        </div>
                        ...
                        <div className=' border-2 shadow-lg text-slate-400font-medium border-slate-500 text-center p-5 space-y-1 rounded-2xl'>
                            ...
                            <h1>Messenger</h1>
                            <p>Shamsut Tabriz</p>
                            <p className='text-blue-400 pt-3 cursor-pointer'>Send a message</p>
                        </div>
                    ...
                    <div className='w-full text-md md:text-lg text-slate-400 font-medium mt-12 md:mt-55 md:pl-32'>
                        <div className="flex justify-start items-center">
                            ...
                            >
                                ...
                                <button className="w-[7rem] md:w-[10rem] border-2 border-slate-400 hover:border-slate-300 px-5 py-2 text-[10px] md:text-[12px] md:text-md font-semibold uppercase text-slate-400 hover:text-slate-300 duration-200 mt-10">
                                    Let's Talk
                                </button>
                            </form>
                        </div>
