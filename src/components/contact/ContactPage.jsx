...
const ContactPage = () => {
    return (
        ...
        <div id='contact_me' className='bg-gradient-to-bl from-slate-900 via-slate-800 to-slate-900 py-16 md:py-32'>
                ...
                <div className='md:flex justify-end items-center'>
                    <div className='w-full md:w-6/12 text-slate-500 space-y-5'>
                        <div className=' border-2 shadow-lg text-slate-400font-medium border-slate-500 text-center p-5 space-y-1 rounded-ss-full rounded-se-full'>
                            ...
                            <a href='mailto:johndoe@fakeemail.com' target='_blank' className='text-blue-400 pt-2 cursor-pointer'>Send a message</a>
                        </div>
                        ...
                        <div className=' border-2 shadow-lg text-slate-400font-medium border-slate-500 text-center p-5 space-y-1 rounded-2xl'>
                            ...
                            <h1>Messenger</h1>
                            <p>Shamsut Tabriz</p>
                            <a href='https://msng.link/o?shamsuttabriz1=fm' target='_blank' className='text-blue-400 pt-3 cursor-pointer'>Send a message</a>
                        </div>
                        ...
                        <div className=' border-2 shadow-lg text-slate-400font-medium border-slate-500 text-center p-5 space-y-1 rounded-2xl'>
                            ...
                            <h1>Whatsapp</h1>
                            <p>+8801986884508</p>
                            <a href='https://wa.link/rp7gsf' target='_blank' className='text-blue-400 pt-3 cursor-pointer'>Send a message</a>
                        </div>
                    </div>
